        ...
        <div className="row justify-content-center">
          <div className="col-12 col-sm-10 col-md-7 col-lg-5">
            ...
            <div className="alert alert-info small mb-3">
              <strong>ℹ️ New accounts</strong> are created as <strong>Screener</strong> by default.
              You will be able to add and view screening records.
              The Health Information Manager will review and approve your entries.
            </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    ...
                    <input className="form-control" value={form.fullName}
                      onChange={set("fullName")} required minLength={2} />
                  </div>
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                    ...
                    <input className="form-control" value={form.facilityName}
                      onChange={set("facilityName")} required />
                  </div>
                  <div className="mb-3">
            ...
            <div className="card mt-3 border-0 bg-light">
              <div className="card-body p-3 small text-muted">
                ...
                <ul className="mb-0 mt-1 ps-3">
                  <li><strong>Screener</strong> — Add screenings, view records, export data</li>
                  <li><strong>Manager</strong> — All of the above + review queue, approve/flag records</li>
                  <li><strong>Admin</strong> — Full access including user management</li>
                </ul>
                <div className="mt-2">Contact your administrator to be upgraded to Manager or Admin.</div>
              </div>
            </div>
          </div>
        </div>
