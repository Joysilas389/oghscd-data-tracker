        ...
        <div className="row justify-content-center">
          <div className="col-12 col-sm-9 col-md-6 col-lg-5 col-xl-4">
            <div className="text-center mb-4">
              ...
              <p className="text-muted small mb-0">Oda Government Hospital · Birim Central, Eastern Region</p>
            </div>
            <div className="card shadow border-0">
              <div className="card-body p-4">
                ...
                <p className="text-center small text-muted mb-0">
                  No account? <Link href="/register" className="text-decoration-none">Register here</Link>
                </p>
              </div>
            </div>
